...
function useCreateControls(mode) {
    ...
    var scope = React.useState(function () { return (__assign(__assign({}, partialScope), { mode: mode, target: new three.Vector3(), onChange: function (event) { } })); })[0];
    var internals = {
...
function useControls(mode) {
    ...
    var controls = React.useMemo(function () { return useCreateControls(mode); }, [mode]);
    return [
