    ...
    var update = (function () {
        ...
        return function (invalidate) {
            ...
            if (internals.zoomChanged
                || lastPosition.distanceToSquared(scope.camera.position) > EPSILON || 8 * (1 - lastQuaternion.dot(scope.camera.quaternion)) > EPSILON) {
                invalidate();
...
function OrbitControls(_a) {
    var controls = _a.controls, invalidate = _a.invalidate, props = __rest(_a, ["controls", "invalidate"]);
    ...
    fiber.useFrame(function () { return controls.functions.update(invalidate); }, -1);
    return null;
}
function useControls() {
    ...
    return [
        function (props) {
            var invalidate = fiber.useThree(function (state) { return state.invalidate; });
            return (React__default["default"].createElement(OrbitControls, __assign({ controls: controls, invalidate: invalidate }, props)));
        },
        controls.events,
