...
function OrbitControls(_a) {
    ...
    useFrame(function () { return controls.functions.update(invalidate); }, -1);
    return null;
}
function useControls() {
    ...
    return [
        function (props) {
            var invalidate = useThree(function (state) { return state.invalidate; });
            return (React.createElement(OrbitControls, __assign({ controls: controls, invalidate: invalidate }, props)));
        },
        controls.events,
